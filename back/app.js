      ...
      schemas: {
        ...
        ServicioFinanciado: {
          ...
          properties: {
            _id: {
              type: "string",
              description: "ID único del servicio financiado.",
            },
            cliente_id: {
              type: "string",
              description: "ID del cliente asociado al servicio.",
            },
            descripcion: {
              type: "string",
              description: "Descripción del servicio financiado.",
            },
            monto_servicio: {
              type: "number",
            ...
            fecha_termino: {
              type: "string",
              format: "date",
              description: "Fecha de término del servicio.",
            },
            pago_semanal: {
              type: "number",
            ...
            saldo_restante: {
              type: "number",
              description: "Saldo restante del servicio.",
            },
          },
          required: [
            "cliente_id",
        ...
        Cotizacion: {
          ...
          properties: {
            ...
            forma_pago: {
              type: "string",
              description: "Forma de pago (Contado, Financiado, etc.).",
            },
            precio_venta: {
              type: "number",
              description: "Precio de venta del servicio.",
            },
            anticipo_solicitado: {
              type: "number",
              description: "Anticipo solicitado.",
            },
            filial: {
              type: "string",
              description: "Filial asociada a la cotización.",
            },
            cliente_id: {
              type: "string",
            ...
            detalles: {
              ...
              items: {
                ...
                properties: {
                  ...
                  costo_materiales: {
                    type: "number",
                    description: "Costo de los materiales.",
                  },
                  costo_mano_obra: {
                    type: "number",
                    description: "Costo de la mano de obra.",
                  },
                  inversion: {
                    type: "number",
